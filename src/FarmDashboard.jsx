...
export default function FarmDashboardPage() {
  ...
  // Simple demo calculation for the What-If simulator
  ...
  const predictedProfit = predictedYield * 1900;
    ...
    <Layout title="Farm Dashboard">
      <div className="space-y-6">
        ...
        <div className="rounded-3xl bg-[#d9f4dc] p-6">
          ...
          {/* Simulator content */}
          <div className="mt-6 grid grid-cols-1 gap-8 lg:grid-cols-[1fr_1fr_1fr_1.25fr]">
