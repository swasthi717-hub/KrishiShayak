  ...
  useEffect(() => {
    async function loadWeather() {
      try {
        ...
        /*
         * Get state and district saved during onboarding.
         */
        ...
        /*
         * Convert state + district into coordinates.
         * This is NOT the user's live GPS location.
         */
        ...
        /*
         * Fetch weather for the onboarding location.
         */
        ...
        /*
         * Display the onboarding location instead of
         * reverse-geocoding the user's live GPS.
         */
        setLocationName({
          city: district,
          state: state,
      ...
      <Layout title="Weather">
        <div className="rounded-[24px] bg-red-50 p-6 text-center">
          ...
          <p className="mt-3 text-sm text-gray-500">
            Please check that your state and district are correctly
            saved in your profile and try again.
          </p>
        </div>
      </Layout>
    );
